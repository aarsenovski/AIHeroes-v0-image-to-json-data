          ...
          {messages.length === 0 ? (
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Simply click the image button below to get started. Our AI will analyze your image and find matching products instantly.
              </p>
            </div>
          ) : isAnalyzing ? (
                    ...
                    <div className="w-full space-y-4">
                      {message.analyzedImageUrl && (
                        <Card className="bg-card p-6">
                          <div className="mb-4">
                            <h3 className="text-xl font-semibold text-foreground">Analyzed Image</h3>
                          </div>
